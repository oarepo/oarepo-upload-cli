...
current_dir, home_dir, config_home_dir = (
    ".",
    os.environ["HOME"],
    f'{os.environ["HOME"]}/.config',
)
...
@pytest.mark.parametrize(
    "token,expected", [("curr_dir1", "curr_dir1"), ("curr_dir2", "curr_dir2")]
)
...
@pytest.mark.parametrize(
    "token,expected", [("home_dir1", "home_dir1"), ("home_dir2", "home_dir2")]
)
...
@pytest.mark.parametrize(
    "token,expected",
    [
        ("config_home_dir1", "config_home_dir1"),
        ("config_home_dir2", "config_home_dir2"),
    ],
)
