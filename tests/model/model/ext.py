...
class ModelExt:
    ...
    def init_resource(self, app):
        ...
        self.service = app.config["MODEL_SERVICE_CLASS"](
            config=app.config["MODEL_SERVICE_CONFIG"](),
        )
        self.resource = app.config["MODEL_RESOURCE_CLASS"](
            service=self.service,
            config=app.config["MODEL_RESOURCE_CONFIG"](),
        )
